...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestUser.access_token_expires'
        db.add_column('facetools_testuser', 'access_token_expires', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TestUser.access_token_expires'
        db.delete_column('facetools_testuser', 'access_token_expires')
